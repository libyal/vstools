...
class Bzip2VSProjectInformationTest(test_lib.BaseTestCase):
    ...
    def testInitialize(self):
        ...
        self.assertIn("..\\..\\..\\bzip2\\compress.c", project_information.source_files)

        self.assertIn("..\\..\\..\\bzip2\\bzlib.h", project_information.header_files)
...
class ZlibVSProjectInformationTest(test_lib.BaseTestCase):
    ...
    def testInitialize(self):
        ...
        self.assertIn("..\\..\\..\\zlib\\adler32.c", project_information.source_files)

        self.assertIn("..\\..\\..\\zlib\\zlib.h", project_information.header_files)
...
class ReleaseDllVSProjectConfiguration(test_lib.BaseTestCase):
    ...
    def testInitialize(self):
        ...
        self.assertEqual(configuration.import_library, "$(OutDir)\\$(ProjectName).lib")
