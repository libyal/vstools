...
class VSConfigurationsTest(test_lib.BaseTestCase):
    ...
    def testAppend(self):
        ...
        configuration = resources.VSSolutionConfiguration(name="test", platform="Win32")
...
class VSProjectConfigurationTests(test_lib.BaseTestCase):
    ...
    def testBasicRuntimeChecksString(self):
        ...
        self.assertEqual(project_configuration.basic_runtime_checks_string, "Default")
    ...
    def testCompilerAsString(self):
        ...
        self.assertEqual(project_configuration.compile_as_string, "CompileAsCpp")
    ...
    def testDataExecutionPreventionString(self):
        ...
        self.assertEqual(project_configuration.data_execution_prevention_string, "true")
    ...
    def testDebugInformationFormatString(self):
        ...
        self.assertEqual(
            project_configuration.debug_information_format_string, "ProgramDatabase"
        )
    ...
    def testEnableComdatFoldingString(self):
        ...
        self.assertEqual(project_configuration.enable_comdat_folding_string, "true")
    ...
    def testLinkIncrementalString(self):
        ...
        self.assertEqual(project_configuration.link_incremental_string, "false")
    ...
    def testOptimizeReferencesString(self):
        ...
        self.assertEqual(project_configuration.optimize_references_string, "true")
    ...
    def testOutputTypeString(self):
        ...
        self.assertEqual(project_configuration.output_type_string, "Application")

        project_configuration.output_type = "2"
        self.assertEqual(project_configuration.output_type_string, "DynamicLibrary")

        project_configuration.output_type = "4"
        self.assertEqual(project_configuration.output_type_string, "StaticLibrary")
    ...
    def testRandomizedBaseAddressString(self):
        ...
        self.assertEqual(project_configuration.randomized_base_address_string, "false")

        project_configuration.randomized_base_address = "2"
        self.assertEqual(project_configuration.randomized_base_address_string, "true")
    ...
    def testTargetMachineString(self):
        ...
        self.assertEqual(project_configuration.target_machine_string, "MachineX86")

        project_configuration.target_machine = "2"
        self.assertEqual(project_configuration.target_machine_string, "MachineX64")
    ...
    def testWholeProgramOptimizationString(self):
        ...
        self.assertEqual(project_configuration.whole_program_optimization_string, "")
