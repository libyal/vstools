...
class FileWriterTest(test_lib.BaseTestCase):
    ...
    def testWriteLines(self):
        ...
        file_writer.WriteLines(["First line of text", "Second line of text"])

        file_writer._file.seek(0, os.SEEK_SET)
        output_data = file_writer._file.read()
        expected_output_data = b"First line of text\r\nSecond line of text\r\n"
        self.assertEqual(output_data, expected_output_data)
